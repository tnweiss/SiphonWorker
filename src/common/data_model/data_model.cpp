...
int8_t DataModel::model_type() { return _type; }
...
std::string DataModel::frame_accessor(const char *field) {
  ...
  if (_type == DATA_MODEL_CODE_ARRAY) {
    ...
    throw siphon::DataModelParseException("Field ", field,
                                          " Not found in the list of fields");
  } else {
    throw siphon::DataModelParseException(
        "Not able to handle map at this time");
  }
}

bool DataModel::operator==(DataModel &) { return false; }
